...
//         let formData = {};
//         formData.carMake = document.querySelector('#carMake').value;
//         formData.carModel = document.querySelector('#carModel').value;
//         formData.year = document.querySelector('#year').value;
//         formData.km = document.querySelector('#km').value;
//         formData.rego = document.querySelector('#rego').value;
//         formData.postCode = document.querySelector('#postCode').value;
//         formData.price = document.querySelector('#price').value;
//         formData.seatingCapacity = document.querySelector('#seatingCapacity').value;
//         formData.fuelType = document.querySelector('#fuelType').value;
//         formData.transmission = document.querySelector('#transmission').value;
//         formData.maxPower = document.querySelector('#maxPower').value;
//         formData.torque = document.querySelector('#torque').value;
//         formData.sellerType = document.querySelector('#sellerType').value;
//         formData.owner = document.querySelector('#owner').value;
        

//         // Log or use the formData as needed
//         data.push(formData);
//         console.log(data);
//     })
// }
...
//             console.log('ele',ele.value,label)
//             ele.value = '';
//         })
...
//         const imgSrc = card.photos.startsWith('data:') ? card.photos : `data:image/jpeg;base64,${getBase64Image(card.photos)}`;
//           return  `  
//             <div class="card">
